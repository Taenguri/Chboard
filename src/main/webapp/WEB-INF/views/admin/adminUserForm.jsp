...
<div class="content" style="display:flex; justify-content:center; align-items: center;">
	...
	<div class="form-border">
		...
		<button id="adminUserUpdate_btn" class="userBtn">수정</button>
		<button id="adminUserdelete_btn" class="userBtn">삭제</button>
		<button onclick="location.href='/userList'"class="userBtn">돌아가기</button>
	</div>

</div>
<script src="/js/admin/adminUserForm.js"></script>
